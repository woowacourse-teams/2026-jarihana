...
public enum ErrorCode {
    ...
    GROUP_MEMBER_NOT_FOUND(HttpStatus.NOT_FOUND),
    GROUP_MEMBER_ALREADY_EXISTS(HttpStatus.CONFLICT),
    GROUP_MEMBER_ALREADY_LEADER(HttpStatus.UNPROCESSABLE_CONTENT),
    LEADER_DELEGATION_NOT_ALLOWED_FOR_ENDED_GROUP(HttpStatus.UNPROCESSABLE_CONTENT),
    ...
    IMAGE_CONTENT_TYPE_NOT_ALLOWED(HttpStatus.BAD_REQUEST),
    IMAGE_FILE_TOO_LARGE(HttpStatus.BAD_REQUEST),
    IMAGE_UPLOAD_URL_ISSUE_FAILED(HttpStatus.BAD_GATEWAY),
    ...
    RECRUITMENT_ALREADY_CLOSED(HttpStatus.CONFLICT),
    RECRUITMENT_INVALID_PERIOD(HttpStatus.BAD_REQUEST),
    RECRUITMENT_NOT_OPEN(HttpStatus.CONFLICT),
    RECRUITMENT_CAPACITY_EXCEEDED(HttpStatus.CONFLICT),
    REGISTRATION_ALREADY_EXISTS(HttpStatus.CONFLICT),
    REGISTRATION_NOT_FOUND(HttpStatus.NOT_FOUND),
    REGISTRATION_ACCESS_DENIED(HttpStatus.FORBIDDEN),
    REGISTRATION_ALREADY_DECIDED(HttpStatus.CONFLICT),
    GROUP_PENDING_REGISTRATION_EXISTS(HttpStatus.CONFLICT),
